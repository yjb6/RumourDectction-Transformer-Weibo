...
from rumoure_dection.codes.Layers import FeedForwardNetwork
from rumoure_dection.codes.Layers import MultiHeadAttention
...
class Layer(nn.Module):
  ...
  def forward(self, query, key, val, key_structure=None, val_structure=None, attention_mask=None):
    self_atten_features, atten_values = self.attn_network(query, key, val, key_structure=key_structure,
