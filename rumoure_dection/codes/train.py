...
print(sys.path)
import HierarchicalTransformer
...
class Trainer():
  ...
  def train(self):
    ...
    name = "{}_split_{}_{}".format(dataset, self.iter,
                                   datetime.now().strftime('%Y-%m-%d-%H_%M_%S'))  # Date & Time for logging purposes
    ...
    for epoch in tqdm(range(self.config.num_epoch)):
      ...
      with torch.no_grad():
        ...
        acc_test, pre_test, recall_test, f_score_test, counter_true_test, counter_pred_test = cal_scores(pred_test,
                                                                                                         true_test,
                                                                                                         type_="all")
        if(acc_test<best_acc_test and acc_test_1<best_acc_test_1 and acc_test_2<best_acc_test_2):
          early_stop+=1
        else:
          early_stop=0
        ...
        if f_score_test_1 >= best_f_score_test_1:
          ...
          if f_score_test_1 == best_f_score_test_1:
            ...
            if f_score_test_2 >= best_f_score_test_1_for_2:
              ...
              save_best_model(path, self.hierarchical_transformer, self.word_encoder, self.word_pos_encoder,
                              self.time_delay_encoder, self.optimizer, "f_score", "test_1")
        ...
        if acc_test_1 >= best_acc_test_1:
          ...
          if acc_test_1 == best_acc_test_1:
            ...
            if acc_test_2 >= best_acc_test_1_for_2:
              ...
              save_best_model(path, self.hierarchical_transformer, self.word_encoder, self.word_pos_encoder,
                              self.time_delay_encoder, self.optimizer, "accuracy", "test_1")
        ...
        if f_score_test_2 >= best_f_score_test_2:
          ...
          if f_score_test_2 == best_f_score_test_2:
            ...
            if f_score_test_1 >= best_f_score_test_2_for_1:
              ...
              save_best_model(path, self.hierarchical_transformer, self.word_encoder, self.word_pos_encoder,
                              self.time_delay_encoder, self.optimizer, "f_score", "test_2")
        ...
        if acc_test_2 >= best_acc_test_2:
          ...
          if acc_test_2 == best_acc_test_2:
            ...
            if acc_test_1 >= best_acc_test_2_for_1:
              ...
              save_best_model(path, self.hierarchical_transformer, self.word_encoder, self.word_pos_encoder,
                              self.time_delay_encoder, self.optimizer, "accuracy", "test_2")
        ...
        if f_score_test >= best_f_score_test:
          ...
          save_best_model(path, self.hierarchical_transformer, self.word_encoder, self.word_pos_encoder,
                          self.time_delay_encoder, self.optimizer, "f_score", "test")
        ...
        if acc_test >= best_acc_test:
          ...
          save_best_model(path, self.hierarchical_transformer, self.word_encoder, self.word_pos_encoder,
                          self.time_delay_encoder, self.optimizer, "accuracy", "test")
